...
public static class ct
{
    ...
    /// <summary>
    /// add a new action to input
    /// </summary>
    public static void AddAction(string key,string biding,InputActionType type)
    {
        InputAction ia = new(
            type: type,
            binding: biding
    ...
    public static int GetBindingIndex(InputAction action, string path)
    {
    ...
    public static void ChangeAction(string key, string overrided, string biding)
    {
